...
import com.wiredi.processor.plugins.ProcessorPluginContext;
...
public abstract class WireBaseProcessor extends AbstractProcessor {
        ...
        if (roundEnv.processingOver()) {
            ...
            targetAnnotations().forEach(annotation -> {
                ...
                Logger.trackAnnotation(annotation, () -> {
                    dispatchProcessingRound(annotation, roundEnv, annotation);
    ...
    private void dispatchProcessingRound(Class<? extends Annotation> annotation, RoundEnvironment roundEnv, Class<? extends Annotation> annotationType) {
