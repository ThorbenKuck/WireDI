...
public class RetryPolicy {
    ...
    public static class Builder {
         ...
         * Every {@link RetryTemplate} execution has at least one attempt, which means that the
         ...
         * This specifies the retries the {@link RetryTemplate} can take.
         *
         * @param maxAttempts the maximum of code executions.
         * @return this builder
         */
        public Builder withMaxAttempts(final long maxAttempts) {
            is(maxAttempts >= 1, () -> "Every RetryPolicy will have to have at least one max attempt, otherwise code won't be executed at all.");
            this.maxAttempts = maxAttempts;
            return this;
        }
