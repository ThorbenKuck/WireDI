...
public class SafeReference<T> {
	...
	public SafeReference() { this(null); }
	...
	public static class ValueMissingIfPresentStage implements IfPresentStage {
	...
	public static class ValuePresentIfPresentStage implements IfPresentStage {
