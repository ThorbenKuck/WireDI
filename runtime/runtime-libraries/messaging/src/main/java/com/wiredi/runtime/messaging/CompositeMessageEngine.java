 ...
 */
public class CompositeMessageEngine implements MessagingEngine {

    private final Map<MapId, MessageConverter<?, ?>> lastHitConverts = new ConcurrentHashMap<>();
    private final List<MessageConverter<?, ?>> converters;
    private static final Logging logger = Logging.getInstance(CompositeMessageEngine.class);

    public CompositeMessageEngine(List<MessageConverter<?, ?>> converters) {
