 ...
 * <p>
 * If constructed using the default constructor, a new TypedProperties is constructed for each individual thread.
 * <p>
...
public final class ThreadLocalTypedProperties extends ThreadLocal<TypedProperties> {
    ...
    @Override
    protected final TypedProperties initialValue() {
