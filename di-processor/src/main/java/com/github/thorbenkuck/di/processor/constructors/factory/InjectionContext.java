...
import com.github.thorbenkuck.di.processor.util.WiredTypeUtils;
...
class InjectionContext {
    ...
    public void announceFieldInjection(VariableElement variableElement) {
        if(WiredTypeUtils.isWireCandidate(variableElement.asType())) {
            Logger.warn("The declared type " + variableElement.asType().toString() + " is not declared as a wire candidate", variableElement);
        }
