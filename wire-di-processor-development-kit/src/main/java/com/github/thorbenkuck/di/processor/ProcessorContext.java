...
public class ProcessorContext {
	...
	public static void ifFilerSet(Consumer<Filer> filerConsumer) {
		Filer currentFiler = filer.get();
		if(currentFiler != null) {
			filerConsumer.accept(currentFiler);
		}
	}
	...
	public static boolean isFilerSet() {
		return filer.get() != null;
	}
}
